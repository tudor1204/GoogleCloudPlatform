...
# [START gke_postgresql_vpc_multi_region_network]
module "gcp-network" {
...
# [END gke_postgresql_vpc_multi_region_network]

# [START gke_postgresql_cloudnat_simple_create]
module "cloud_router" {
...
# [END gke_postgresql_cloudnat_simple_create]